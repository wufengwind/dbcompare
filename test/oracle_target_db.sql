-- Oracle Target Database Test Script
...
CREATE TABLE users (
    ...
    country VARCHAR2(50) DEFAULT 'China',  -- 新增字段
...
CREATE TABLE products (
    ...
    min_stock_level NUMBER(10) DEFAULT 10,  -- 新增字段
    category_id NUMBER(10),
    sku VARCHAR2(50) UNIQUE,
    brand VARCHAR2(100),  -- 新增字段
    weight NUMBER(8,2),   -- 新增字段
...
CREATE OR REPLACE VIEW target_only_view AS
...
CREATE OR REPLACE PROCEDURE TargetOnlyProcedure(p_id IN NUMBER, p_value IN NUMBER)
IS
BEGIN
...
CREATE OR REPLACE FUNCTION GetDiscountedPrice(p_price IN NUMBER, p_discount_rate IN NUMBER DEFAULT 0.15)
RETURN NUMBER
IS
BEGIN
...
CREATE OR REPLACE FUNCTION GetProductAverageRating(p_product_id IN NUMBER)
RETURN NUMBER
IS
...
CREATE OR REPLACE FUNCTION TargetOnlyFunction(p_input IN VARCHAR2)
RETURN VARCHAR2
IS
BEGIN
